...
abstract class Model
{
    ...
    public function errorMassage()
    {
        return [
            ...
            self::RULE_EMAIL => 'This field should be an email',
            self::RULE_MIN => 'This field should be at least {min}',
            self::RULE_MAX => 'This field should be at least {max}',
            self::RULE_MATCH => 'dos not match the password',
